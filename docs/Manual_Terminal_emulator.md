...
|Terminal Model|||
|Safety protocol|||
|Code Page|Specifies the EBCDIC code page for the connection. Default is cp037. Spanish cp284|cp037|
...
|Keys|Key to send||
|Quantity|Number of times to send the key|1|
...
|Quantity|Number of places to move|1|
